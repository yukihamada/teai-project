...
MicroAgents are specialized prompts that enhance TeAI with domain-specific knowledge and task-specific workflows. They help developers by providing expert guidance, automating common tasks, and ensuring consistent practices across projects. Each microagent is designed to excel in a specific area, from Git operations to code review processes.

## Sources of Microagents

TeAI loads microagents from two sources:

### 1. Shareable Microagents (Public)
This directory (`TeAI/microagents/`) contains shareable microagents that are:
- Available to all TeAI users
- Maintained in the TeAI repository
...
Each repository can have its own instructions in `.teai/microagents/repo.md`. These instructions are:
...
1. Loads repository-specific instructions from `.teai/microagents/repo.md` if present
...
You can see an example of a knowledge-based agent in [TeAI's github microagent](https://github.com/All-Hands-AI/TeAI/tree/main/microagents/knowledge/github.md).

### 2. Repository Agents

Repository agents provide repository-specific knowledge and guidelines. They are:
- Loaded from `.teai/microagents/repo.md`
...
You can see an example of a repo agent in [the agent for the TeAI repo itself](https://github.com/All-Hands-AI/TeAI/blob/main/.teai/microagents/repo.md).
...
Example workflow:
You can see an example of a task-based agent in [TeAI's pull request updating microagent](https://github.com/All-Hands-AI/TeAI/tree/main/microagents/tasks/update_pr_description.md).
...
1. Create your agent file in the appropriate directory:
   ...
   - Note: Repository agents should remain in their respective repositories' `.teai/microagents/` directory
2. Test thoroughly
3. Submit a pull request to TeAI


## License

All microagents are subject to the same license as TeAI. See the root LICENSE file for details.
