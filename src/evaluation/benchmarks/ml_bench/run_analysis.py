...
from teai.core.config import get_llm_config_arg, get_parser, load_app_config
...
if __name__ == '__main__':
    ...
    # Check https://github.com/All-Hands-AI/TeAI/blob/main/evaluation/swe_bench/README.md#configure-teai-and-your-llm
