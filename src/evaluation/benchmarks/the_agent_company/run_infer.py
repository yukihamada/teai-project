...
from teai.events.observation import BrowserOutputObservation, CmdOutputObservation
...
def get_config(
    ...
    config = AppConfig(
        ...
        # we mount trajectories path so that trajectories, generated by TeAI
...
if __name__ == '__main__':
    ...
    # 1) trajectory is dumped by TeAI library (on host machine), but it's needed by
