...
from teai.events.action import AgentFinishAction, MessageAction
...
class Test(BaseIntegrationTest):
    INSTRUCTION = 'Look at https://github.com/All-Hands-AI/TeAI/pull/8, and tell me what is happening there and what did @asadm suggest.'
