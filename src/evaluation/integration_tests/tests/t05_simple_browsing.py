...
from teai.events.action import AgentFinishAction, CmdRunAction, MessageAction
from teai.events.event import Event
from teai.events.observation import AgentDelegateObservation
...
<body>
    ...
    <script>
        document.getElementById('showButton').addEventListener('click', function() {
            document.getElementById('result').innerText = 'The answer is TeAI is all you need!';
        });
    </script>
</body>
</html>
...
class Test(BaseIntegrationTest):
    ...
    def verify_result(cls, runtime: Runtime, histories: list[Event]) -> TestResult:
        ...
        # check if the "The answer is TeAI is all you need!" is in any message
        message_actions = [
            event
        ...
        for event in message_actions:
            try:
                ...
                if 'TeAI is all you need!' in content:
