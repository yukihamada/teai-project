...
TeAI fournit un mode Interface Graphique (GUI) convivial pour interagir avec l'assistant IA. Ce mode offre une façon intuitive de configurer l'environnement, gérer les paramètres et communiquer avec l'IA.

## Installation et Configuration

1. Suivez les instructions du guide [Installation](../installation) pour installer TeAI.

2. Après avoir exécuté la commande, accédez à TeAI à l'adresse [http://localhost:3000](http://localhost:3000).
...
TeAI exporte automatiquement un `GITHUB_TOKEN` vers l'environnement shell s'il est disponible. Cela peut se produire de deux manières :
...
Lorsque vous utilisez TeAI en mode en ligne, le flux OAuth GitHub :
...
2. Étapes d'authentification :
   ...
   - Autorisez TeAI à accéder à votre compte GitHub
...
N'oubliez pas que le mode Interface Graphique d'TeAI est conçu pour rendre votre interaction avec l'assistant IA aussi fluide et intuitive que possible. N'hésitez pas à explorer ses fonctionnalités pour maximiser votre productivité.
