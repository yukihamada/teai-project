...
Lorsque vous travaillez avec le développeur de logiciels TeAI AI, il est crucial de fournir des prompts clairs et efficaces. Ce guide décrit les meilleures pratiques pour créer des prompts qui produiront les réponses les plus précises et les plus utiles.
...
Voir [Démarrer avec TeAI](../getting-started) pour plus d'exemples de prompts utiles.
