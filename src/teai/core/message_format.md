# TeAI Message Format and litellm Integration

## Overview

TeAI uses its own `Message` class (`teai/core/message.py`) which provides rich content support while maintaining compatibility with litellm's message handling system.

## Class Structure

Our `Message` class (`teai/core/message.py`):
