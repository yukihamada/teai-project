...
from teai.core.logger import LOG_DIR
...
class LLMConfig(BaseModel):
    ...
    Attributes:
        ...
        custom_llm_provider: The custom LLM provider to use. This is undocumented in teai, and normally not used. It is documented on the litellm side.
    ...
    openrouter_app_name: str = Field(default='TeAI')
