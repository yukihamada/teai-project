...
- The detailed implementation of the linter can be found at: https://github.com/All-Hands-AI/teai-aci.
"""

from teai_aci.linter import DefaultLinter, LintResult
