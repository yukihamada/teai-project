...
def handle_observation_deprecated_extras(extras: dict) -> dict:
    # These are deprecated in https://github.com/All-Hands-AI/TeAI/pull/4881
    ...
    # formatted_output_and_error has been deprecated in https://github.com/All-Hands-AI/TeAI/pull/6671
