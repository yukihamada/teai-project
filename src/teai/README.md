...
This directory contains the core components of TeAI.

This diagram provides an overview of the roles of each component and how they communicate and collaborate.
![TeAI System Architecture Diagram (July 4, 2024)](../docs/static/img/system_architecture_overview.png)

## Classes

The key classes in TeAI are:
...
* Server: brokers TeAI sessions over HTTP, e.g. to drive the frontend
...
The EventStream serves as the backbone for all communication in TeAI.
