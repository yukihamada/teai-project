...
from teai.controller.agent import Agent
from teai.controller.replay import ReplayManager
from teai.controller.state.state import State, TrafficControlState
from teai.controller.stuck import StuckDetector
from teai.core.config import AgentConfig, LLMConfig
...
from teai.core.logger import LOG_ALL_EVENTS
from teai.core.logger import teai_logger as logger
from teai.core.schema import AgentState
from teai.events import (
    EventSource,
    EventStream,
...
from teai.events.action.agent import RecallAction
...
from teai.events.serialization.event import event_to_trajectory, truncate_content
from teai.llm.llm import LLM
from teai.llm.metrics import Metrics, TokenUsage
...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        TeAI is a multi-agentic system. A `task` is a conversation between
        TeAI (the whole system) and the user, which might involve one or more inputs
