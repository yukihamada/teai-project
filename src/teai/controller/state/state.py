...
from teai.storage.locations import get_conversation_agent_state_filename
...
class State:
    """
    Represents the running state of an agent in the TeAI system, saving data of its operation and memory.
    ...
    def to_llm_metadata(self, agent_name: str) -> dict:
        return {
            ...
            'trace_version': teai.__version__,
            'tags': [
                f'agent:{agent_name}',
                f'web_host:{os.environ.get("WEB_HOST", "unspecified")}',
                f'teai_version:{teai.__version__}',
            ],
        }
