...
from teai.microagent.types import MicroAgentMetadata, MicroAgentType
...
class BaseMicroAgent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .teai_instructions
        if path.name == '.teai_instructions':
...
class RepoMicroAgent(BaseMicroAgent):
    ...
    RepoMicroAgents are loaded from `.teai/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .teai/microagents)
    ...
    # Load all agents from .teai/microagents directory
