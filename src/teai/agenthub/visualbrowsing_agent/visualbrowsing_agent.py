...
from teai.agenthub.browsing_agent.response_parser import BrowsingResponseParser
from teai.controller.agent import Agent
from teai.controller.state.state import State
from teai.core.config import AgentConfig
...
from teai.events.observation import BrowserOutputObservation
...
"""
    ...
    def step(self, state: State) -> Action:
        ...
        # we should also send a message back to the user in TeAI and call it a day
        if (
