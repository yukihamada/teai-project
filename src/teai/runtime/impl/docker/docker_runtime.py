...
from teai.core.exceptions import (
    AgentRuntimeDisconnectedError,
    AgentRuntimeNotFoundError,
)
from teai.core.logger import DEBUG, DEBUG_RUNTIME
from teai.core.logger import teai_logger as logger
from teai.events import EventStream
from teai.runtime.builder import DockerRuntimeBuilder
from teai.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from teai.runtime.impl.docker.containers import stop_all_containers
...
from teai.runtime.utils.log_streamer import LogStreamer
from teai.runtime.utils.runtime_build import build_runtime_image
from teai.utils.async_utils import call_sync_from_async
from teai.utils.shutdown_listener import add_shutdown_listener
from teai.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'teai-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _init_container(self):
        ...
        if (
            ...
            # e.g. result would be: {"/home/user/teai/workspace": {'bind': "/workspace", 'mode': 'rw'}}
            volumes = {
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/teai/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None):
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'teai-sandbox-' prefix
        """
        super().close()
