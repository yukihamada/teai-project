...
function activate(context) {
    ...
    let startMonitorCommand = vscode.commands.registerCommand('teai-memory-monitor.startMemoryMonitor', function () {
        memoryMonitor.start();
    });

    // Register memory monitor stop command
    let stopMonitorCommand = vscode.commands.registerCommand('teai-memory-monitor.stopMemoryMonitor', function () {
        memoryMonitor.stop();
    });

    // Register memory details command
    let showMemoryDetailsCommand = vscode.commands.registerCommand('teai-memory-monitor.showMemoryDetails', function () {
