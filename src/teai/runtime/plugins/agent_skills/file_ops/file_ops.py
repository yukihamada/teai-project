"""File operations module for TeAI agent.

This module provides a collection of file manipulation skills that enable the TeAI
...
from teai.linter import DefaultLinter, LintResult
