...
from teai.core.message import Message
from teai.llm.debug_mixin import DebugMixin
from teai.llm.fn_call_converter import (
    STOP_WORDS,
    convert_fncall_messages_to_non_fncall_messages,
    convert_non_fncall_messages_to_fncall_messages,
)
from teai.llm.metrics import Metrics
from teai.llm.retry_mixin import RetryMixin
...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        # Azure issue: https://github.com/All-Hands-AI/TeAI/issues/6777
