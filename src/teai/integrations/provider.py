...
from teai.integrations.github.github_service import GithubServiceImpl
from teai.integrations.gitlab.gitlab_service import GitLabServiceImpl
from teai.integrations.service_types import (
    AuthenticationError,
    GitService,
    Repository,
    User,
