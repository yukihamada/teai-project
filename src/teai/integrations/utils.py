...
from teai.integrations.github.github_service import GitHubService
from teai.integrations.gitlab.gitlab_service import GitLabService
from teai.integrations.provider import ProviderType
