...
from teai.core.config.condenser_config import (
    LLMSummarizingCondenserConfig,
)
from teai.core.const.guide_url import TROUBLESHOOTING_URL
from teai.core.logger import TeAILoggerAdapter
from teai.core.schema import AgentState
from teai.events.action import MessageAction, NullAction
...
from teai.server.session.agent_session import AgentSession
from teai.server.session.conversation_init_data import ConversationInitData
...
class Session:
    ...
    def __init__(
        ...
        self.logger = TeAILoggerAdapter(extra={'session_id': sid})
