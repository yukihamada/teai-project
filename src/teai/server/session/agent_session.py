...
from teai.controller import AgentController
...
from teai.core.config import AgentConfig, AppConfig, LLMConfig
from teai.core.exceptions import AgentRuntimeUnavailableError
from teai.core.logger import TeAILoggerAdapter
from teai.core.schema.agent import AgentState
from teai.events.action import ChangeAgentStateAction, MessageAction
from teai.events.event import Event, EventSource
from teai.events.stream import EventStream
from teai.integrations.provider import PROVIDER_TOKEN_TYPE, ProviderHandler
from teai.memory.memory import Memory
from teai.microagent.microagent import BaseMicroAgent
...
class AgentSession:
    ...
    async def _create_memory(
        ...
        if self.runtime:
            ...
            # loads microagents from repo/.teai/microagents
