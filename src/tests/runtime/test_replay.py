...
from teai.core.config.config_utils import OH_DEFAULT_AGENT
...
from teai.events.observation.commands import CmdOutputObservation
...
def test_simple_replay(temp_dir, runtime_cls, run_as_teai):
    """
...
def test_simple_gui_replay(temp_dir, runtime_cls, run_as_teai):
    """
    A simple replay test that involves simple terminal operations and edits
...
def test_replay_wrong_initial_state(temp_dir, runtime_cls, run_as_teai):
    """
...
def test_replay_basic_interactions(temp_dir, runtime_cls, run_as_teai):
    """
