...
from teai.events.action.browse import BrowseInteractiveAction
...
def test_browsergym_eval_env(runtime_cls, temp_dir):
    runtime, config = _load_runtime(
        ...
        run_as_teai=False,  # need root permission to access file
        base_container_image='xingyaoww/od-eval-miniwob:v1.0',
        browsergym_eval_env='browsergym/miniwob.choose-list',
        force_rebuild_runtime=True,
    )
    from teai.runtime.browser.browser_env import (
