...
###PS1JSON###
{
  ...
  "working_dir": "/home/runner/work/TeAI/TeAI",
  "py_interpreter_path": "/home/runner/.cache/pypoetry/virtualenvs/teai-ai-ULPBlkAi-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert metadata.working_dir == '/home/runner/work/TeAI/TeAI'
    assert (
        metadata.py_interpreter_path
        == '/home/runner/.cache/pypoetry/virtualenvs/teai-ai-ULPBlkAi-py3.12/bin/python'
    )
