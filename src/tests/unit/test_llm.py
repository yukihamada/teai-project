...
from teai.core.exceptions import OperationCancelled
...
def mock_logger(monkeypatch):
    ...
    monkeypatch.setattr('teai.llm.debug_mixin.llm_prompt_logger', mock_logger)
    monkeypatch.setattr('teai.llm.debug_mixin.llm_response_logger', mock_logger)
    monkeypatch.setattr('teai.llm.llm.logger', mock_logger)
    return mock_logger
...
@patch('teai.llm.llm.litellm.get_model_info')
...
@patch('teai.llm.llm.litellm_completion')
@patch('time.time')
...
@patch('teai.llm.llm.litellm.token_counter')
...
@patch('teai.llm.llm.litellm.token_counter')
@patch('teai.llm.llm.create_pretrained_tokenizer')
