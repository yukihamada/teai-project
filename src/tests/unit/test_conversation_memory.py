...
from teai.core.message import ImageContent, Message, TextContent
from teai.events.action import (
    AgentFinishAction,
    CmdRunAction,
    MessageAction,
)
from teai.events.event import (
    Event,
    EventSource,
    FileEditSource,
    FileReadSource,
...
from teai.events.observation import CmdOutputObservation
...
from teai.events.observation.files import FileEditObservation, FileReadObservation
from teai.events.observation.reject import UserRejectObservation
from teai.events.tool import ToolCallMetadata
from teai.memory.conversation_memory import ConversationMemory
from teai.utils.prompt import PromptManager, RepositoryInfo, RuntimeInfo
...
def prompt_dir(tmp_path):
    # Copy contents from "teai/agenthub/codeact_agent" to the temp directory
    shutil.copytree(
        'teai/agenthub/codeact_agent/prompts', tmp_path, dirs_exist_ok=True
    )
