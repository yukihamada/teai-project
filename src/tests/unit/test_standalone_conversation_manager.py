...
from teai.server.conversation_manager.standalone_conversation_manager import (
...
async def test_init_new_local_session():
    ...
    with (
        patch(
            'teai.server.conversation_manager.standalone_conversation_manager.Session',
            mock_session,
        ),
        patch(
            'teai.server.conversation_manager.standalone_conversation_manager.StandaloneConversationManager.get_running_agent_loops',
        ...
        async with StandaloneConversationManager(
            ...
            with (
                patch(
                    'teai.server.conversation_manager.standalone_conversation_manager.StandaloneConversationManager.is_agent_loop_running',
