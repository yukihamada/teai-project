from teai.resolver.patching.apply import apply_diff
from teai.resolver.patching.patch import diffobj, parse_diff
...
-This React application allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the All-Hands-AI organization.
+This React application was created by Graham Neubig and TeAI. It allows you to view open pull requests from GitHub repositories in a GitHub organization. By default, it uses the All-Hands-AI organization."""
