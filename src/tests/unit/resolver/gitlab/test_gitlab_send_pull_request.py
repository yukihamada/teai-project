...
from teai.resolver.interfaces.gitlab import GitlabIssueHandler
...
@patch('teai.resolver.interfaces.gitlab.GitlabIssueHandler.reply_to_comment')
@patch('requests.post')
...
def test_send_pull_request(
    ...
    if pr_type == 'branch':
        assert (
            result
            == 'https://gitlab.com/test-owner/test-repo/-/compare/main...teai-fix-issue-42'
        )
        ...
        assert post_data['source_branch'] == 'teai-fix-issue-42'
...
def test_send_pull_request_branch_naming(
    ...
    assert (
        result
        == 'https://gitlab.com/test-owner/test-repo/-/compare/main...teai-fix-issue-42-try3'
    )
