...
from teai.resolver.send_pull_request import make_commit
...
def test_pr_title_with_quotes(monkeypatch):
    ...
    monkeypatch.setattr(
        'teai.resolver.interfaces.github.GithubIssueHandler.branch_exists',
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        from teai.resolver.send_pull_request import send_pull_request
