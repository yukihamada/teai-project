...
from teai.server.routes.settings import convert_to_settings
from teai.server.settings import POSTSettingsModel, Settings
...
def test_settings_from_config():
    ...
    with patch(
        'teai.server.settings.load_app_config', return_value=mock_app_config
    ):
