...
from teai.core.exceptions import UserCancelledError
from teai.llm.async_llm import AsyncLLM
from teai.llm.llm import LLM
from teai.llm.streaming_llm import StreamingLLM
...
@contextmanager
def _patch_http():
    with patch('teai.llm.llm.requests.get', MagicMock()) as mock_http:
