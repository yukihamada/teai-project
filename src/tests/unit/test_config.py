...
from teai.core.logger import teai_logger
...
def test_compat_env_to_config(monkeypatch, setup_env):
    ...
    monkeypatch.setenv('WORKSPACE_BASE', '/repos/teai/workspace')
    ...
    assert config.workspace_base == '/repos/teai/workspace'
...
[llm]
# Not set in `teai/core/schema/config.py`
invalid_field = "test"
model = "gpt-4"
