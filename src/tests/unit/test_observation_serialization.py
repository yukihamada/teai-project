from teai.core.schema.observation import ObservationType
...
from teai.events.serialization import (
    event_from_dict,
    event_to_dict,
    event_to_trajectory,
)
from teai.events.serialization.observation import observation_from_dict
...
def test_microagent_observation_environment_serialization():
    ...
    assert serialized['extras']['repo_name'] == 'TeAI'
